...
Software is becoming increasingly complex today. Half a century ago, the Appollo 11's flight software was done with around 100,000 lines of code. 
Today, a mobile application such as Telegram contains more than 2,000,000 lines of code. It is estimated that engineers built Google's infrastructure with 2 billion lines of code. Software is written by humans and humans are prone to make mistakes. 
