...
frame=none,
language=C,
basicstyle=\fontfamily{fvm}\small,
showlines=true
...
% 1.34 gives one-and-a-half line spacing, which is allowed
...
\newcommand{\ctool}{\textsf{Quincunx}}
...
\advisor[Dissertation Advisor][Chair of Committee]
		{Dinghao Wu}
		{Professor of Information Sciences and Technology\\The Pennsylvania State University}
...
\readertwo[]
			{Benjamin Hanrahan}
			{Assistant Professor of Information Sciences and Technology\\The Pennsylvania State University}

\readerthree[]
			{Sencun Zhu}
			{Associate Professor of Computer Science and Engineering\\The Pennsylvania State University}

\readerfour[École Polytechnique Fédérale de Lausanne
 (EPFL)\\Special Member]
			{James Larus}
...
\readerfive[]
			{Mary Beth Rosson}
			{Director of Graduate Programs and Professor of Information Sciences and Technology\\The Pennsylvania State University}
