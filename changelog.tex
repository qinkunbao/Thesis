...
Abacus identifies and quantifies side-channel leakages in a single trace. So it suffers from the problem of code coverage.  That is, Abacus may miss some-channel leakages. I have two choices at that time. First, I can use static analysis methods. 
