...
During the evolution of the computer architecture, researchers find that CPUs process data in a much faster speed than the main memory (DRAM) can supply. As a result, CPUs adopt a hierarchy memory architecture to bridge the performance gap between the CPUs and the main memory. By storing extra copies of recently accessed data and code in a smaller but faster memory, the software can get its most recently accessed code and data in a shorter time.
...
The main memory is in the bottom-most under the memory hierarchy.
\begin{figure}[ht]
  \centering
