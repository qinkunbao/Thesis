...
\section{Problem}
Side-channel attacks infer sensitive information such as cryptographic keys, personal data from software products unconsciously. As we discuss in \S\ref{chapter1} and \S\ref{chapter2}, patching software are usually easier than adopting new hardware to defend against side-channel attacks.  
