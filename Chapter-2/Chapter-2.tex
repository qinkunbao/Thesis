...
Recent work~\cite{bernstein2012security,libsodium,zinzindohoue2017hacl,monocypher} also proposes to design and implement clean-slate side-channel free libraries from scratch. We notice that most of these new libraries are cryptographic.  
