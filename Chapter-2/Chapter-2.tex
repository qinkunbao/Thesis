...
Symmetric ciphers like AES can have more than five implementations (OpenSSL). The reference implementation usually adopt T-Tables and S-Tables to speed up the computations. However, such implementation are vulnerable to side-channels and can be exploited to retrieve the whole key~\cite{bonneau2006cache}.
