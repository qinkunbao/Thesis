...
\begin{itemize}
    ...
    \item Today's solvers can not handle some complicated constraints, especially the conjunction of those constraints. Recent studies show existing solvers have bugs when it deals with floating pointer calculations.
\end{itemize}
