...
\begin{table}
    ...
    \label{chapter2:table:crypto}
        ...
        \begin{tabular}{lll}
            ...
            (EC)DSA & Scalar multiplication& Constant time implementation\\
            &Modular inversion &\\
            &Modular reduction &\\
            \bottomrule
        \end{tabular}
