...
In this chapter, we first present related work on existing side-channel attack, mitigation, information quantification, and model counting. After that, we present some background knowledge to facilitate the 
