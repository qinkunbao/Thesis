...
While there is a vast number of studies\cite{yarom2017cachebleed,191010,184415,Osvik2006,liu2015last} on side-channel attacks, we find many of those work targets on the encryption key on cryptography libraries. We find current side-channel attacks can be classified into the below three categories.
