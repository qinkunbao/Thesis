...
who may load the sensitive information to the cache line. On X86-64 machines, it can be achieved by using the \textsf{clflush} instruction. In the next phase,
